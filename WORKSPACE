...
_MEDIAPIPE_VERSION = "0.7.3.1"
http_archive(
    name = "mediapipe",
    url = "https://github.com/google/mediapipe/archive/v%s.tar.gz" % _MEDIAPIPE_VERSION,
    strip_prefix = "mediapipe-%s" % _MEDIAPIPE_VERSION,
)
...
http_archive(
    ...
    patches = [
        ...
        "@mediapipe//third_party:org_tensorflow_protobuf_updates.diff",
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        "@mediapipe//third_party:ceres_solver_9bf9588988236279e1262f75d7f4d85711dfa172.diff"
    ],
    patch_args = [
        "-p1",
    ],
